...
\end{figure}
\footnotetext[2]{Angepasste Version von \url{http://upload.wikimedia.org/wikipedia/commons/3/3d/Patella_bipartita.jpg}}
...
\end{figure}
\footnotetext[4]{Eigene Darstellung mittels MATLAB}
